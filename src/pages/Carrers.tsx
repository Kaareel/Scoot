        ...
        <>
            <header>
                <div className="pb-40">
                    ...
                    <h1 className="relative text-center top-[3.2rem] px-8 text-[40px] leading-[1.2] text-white">Careers</h1>
                </div>
            </header>
            <div className="px-8">
                <div className="text-center">
                    <img src="./images/join-us.jpg" alt="join-us" className="rounded-full" />
                    <div className="my-12">
                        <h2 className="text-4xl font-bold text-textSecondary tracking-[-1.43px] leading-[1.2]">Care to join our mission</h2>
                        <p className="mt-6 text-sm text-textPrimary">We’re always looking for ambitious individuals to help us on our journey. If you’re  passionate about our mission to provide clean, accessible transport to improve urban  living we want to hear from you!</p>
                        <div className="my-12">
                            {/* biome-ignore lint/a11y/useValidAnchor: <explanation> */}
                            <a href="#" className="bg-customOrange border-4 hover:border-2 border-transparent text-white px-12 py-3 mt-4 style rounded">Say Hello</a>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex flex-col gap-5 mt-28 mb-20 py-8">
                    <div className="bg-accordionColor flex flex-col justify-center items-center py-8 gap-2">
                        ...
                        <p className="text-textSecondary text-sm p-2">Jakarta, Indonesia</p>
                        </div>
                        {/* biome-ignore lint/a11y/useValidAnchor: <explanation> */}
                        <a href="#" className="bg-customOrange text-center border-4 hover:border-2 border-transparent text-white font-bold p-3 mt-4 style rounded w-60 max-w-[90%]">Apply</a>
                    </div>
                    <div className="bg-accordionColor flex flex-col justify-center items-center py-8 gap-2">
                        <div>
                    ...
                    <div className="bg-accordionColor flex flex-col justify-center items-center py-8 gap-2">
                        <div>
                        <h2 className="text-textSecondary text-lg">Blog Content Copywriter</h2>
                        <p className="text-textSecondary text-sm p-2">New York, United States</p>
                        </div>
                        {/* biome-ignore lint/a11y/useValidAnchor: <explanation> */}
                        <a href="#" className="bg-customOrange text-center border-4 hover:border-2 border-transparent text-white font-bold p-3 mt-4 style rounded w-60 max-w-[90%]">Apply</a>
                    </div>
                    ...
                    <div className="bg-accordionColor flex flex-col justify-center items-center py-8 gap-2">
                        ...
                        <p className="text-textSecondary text-sm p-2">London, United Kingdom</p>
                        </div>
                        {/* biome-ignore lint/a11y/useValidAnchor: <explanation> */}
                        <a href="#" className="bg-customOrange text-center border-4 hover:border-2 border-transparent text-white font-bold p-3 mt-4 style rounded w-60 max-w-[90%]">Apply</a>
                    </div>
